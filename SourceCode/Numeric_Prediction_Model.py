...
# Load trained model
model = load_model(r'Sign-Language-Recognition-System\Model\SignLang_CNN_Numeric_Model.h5')
labels = [str(i) for i in range(10)]  # Classes 0 to 9
...
while True:
    ...
    original_img = img.copy()  # Keep original for cropping
    img = cv2.flip(img, 1)
